...
import { searchEntities, getEntities } from './restaurant.reducer';
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('coopcycleApp.restaurant.home.search')}
                />
            ...
            <tbody>
              {restaurantList.map((restaurant, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {restaurant.cooperatives
                      ? restaurant.cooperatives.map((val, j) => (
                          <span key={j}>
                            <Link to={`/cooperative/${val.id}`}>{val.id}</Link>
                            {j === restaurant.cooperatives.length - 1 ? '' : ', '}
                          </span>
                        ))
                      : null}
                  </td>
