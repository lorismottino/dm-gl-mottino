...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURIER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_COURIERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_COURIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COURIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COURIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COURIER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COURIER actions', async () => {
      const expectedActions = [
        {
