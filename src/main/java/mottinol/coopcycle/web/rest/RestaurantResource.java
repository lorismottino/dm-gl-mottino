...
/**
 * REST controller for managing {@link mottinol.coopcycle.domain.Restaurant}.
 */
@RestController
@RequestMapping("/api")
public class RestaurantResource {
    ...
    public ResponseEntity<RestaurantDTO> updateRestaurant(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, restaurantDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<RestaurantDTO> partialUpdateRestaurant(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, restaurantDTO.getId())
        );
    }
    ...
    public List<RestaurantDTO> searchRestaurants(@RequestParam String query) {
