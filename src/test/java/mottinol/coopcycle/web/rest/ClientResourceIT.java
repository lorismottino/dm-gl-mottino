...
class ClientResourceIT {
     ...
     *
     * @see mottinol.coopcycle.repository.search.ClientSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.firstname(UPDATED_FIRSTNAME).lastname(UPDATED_LASTNAME).address(UPDATED_ADDRESS);
