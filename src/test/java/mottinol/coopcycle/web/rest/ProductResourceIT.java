...
class ProductResourceIT {
     ...
     *
     * @see mottinol.coopcycle.repository.search.ProductSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void searchProduct() throws Exception {
        ...
        product.setId(UUID.randomUUID().toString());
        productRepository.saveAndFlush(product);
        when(mockProductSearchRepository.search("id:" + product.getId())).thenReturn(Stream.of(product));
